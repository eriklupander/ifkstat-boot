...
public class RegistrationDAOBean implements RegistrationDAO {
	...
	/* (non-Javadoc)
	 * @see se.ifkgoteborg.stat.dao.RegistrationDAO#getOrCreateGround(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see se.ifkgoteborg.stat.dao.RegistrationDAO#getOrCreateClub(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see se.ifkgoteborg.stat.dao.RegistrationDAO#getOrCreatePlayer(java.lang.String, java.util.Date)
	 */
	@Override
